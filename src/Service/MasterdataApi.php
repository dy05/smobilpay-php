...
class MasterdataApi
{
     ...
     *
     * @throws \Dy05Maviance\S3PApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Dy05Maviance\S3PApiClient\Model\Cashin[]
     */
     ...
     * @throws \Dy05Maviance\S3PApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Dy05Maviance\S3PApiClient\Model\Cashin[], HTTP status code, HTTP response headers (array of strings)
     */
    public function cashinGetWithHttpInfo($xApiVersion, $serviceid = null)
    {
        $returnType = '\Dy05Maviance\S3PApiClient\Model\Cashin[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Dy05Maviance\S3PApiClient\Model\Cashin[]',
                ...
                case 0:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Dy05Maviance\S3PApiClient\Model\Error',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Dy05Maviance\S3PApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Dy05Maviance\S3PApiClient\Model\Cashout[]
     */
     ...
     * @throws \Dy05Maviance\S3PApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Dy05Maviance\S3PApiClient\Model\Cashout[], HTTP status code, HTTP response headers (array of strings)
     */
    public function cashoutGetWithHttpInfo($xApiVersion, $serviceid = null)
    {
        $returnType = '\Dy05Maviance\S3PApiClient\Model\Cashout[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Dy05Maviance\S3PApiClient\Model\Cashout[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Dy05Maviance\S3PApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Dy05Maviance\S3PApiClient\Model\Merchant[]
     */
     ...
     * @throws \Dy05Maviance\S3PApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Dy05Maviance\S3PApiClient\Model\Merchant[], HTTP status code, HTTP response headers (array of strings)
     */
    public function merchantGetWithHttpInfo($xApiVersion)
    {
        $returnType = '\Dy05Maviance\S3PApiClient\Model\Merchant[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Dy05Maviance\S3PApiClient\Model\Merchant[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Dy05Maviance\S3PApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Dy05Maviance\S3PApiClient\Model\Product[]
     */
     ...
     * @throws \Dy05Maviance\S3PApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Dy05Maviance\S3PApiClient\Model\Product[], HTTP status code, HTTP response headers (array of strings)
     */
    public function productGetWithHttpInfo($xApiVersion, $serviceid = null)
    {
        $returnType = '\Dy05Maviance\S3PApiClient\Model\Product[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Dy05Maviance\S3PApiClient\Model\Product[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Dy05Maviance\S3PApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Dy05Maviance\S3PApiClient\Model\Service[]
     */
     ...
     * @throws \Dy05Maviance\S3PApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Dy05Maviance\S3PApiClient\Model\Service[], HTTP status code, HTTP response headers (array of strings)
     */
    public function serviceGetWithHttpInfo($xApiVersion)
    {
        $returnType = '\Dy05Maviance\S3PApiClient\Model\Service[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Dy05Maviance\S3PApiClient\Model\Service[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Dy05Maviance\S3PApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Dy05Maviance\S3PApiClient\Model\Topup[]
     */
     ...
     * @throws \Dy05Maviance\S3PApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Dy05Maviance\S3PApiClient\Model\Topup[], HTTP status code, HTTP response headers (array of strings)
     */
    public function topupGetWithHttpInfo($xApiVersion, $serviceid = null)
    {
        $returnType = '\Dy05Maviance\S3PApiClient\Model\Topup[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Dy05Maviance\S3PApiClient\Model\Topup[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
