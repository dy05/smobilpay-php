...
class InitiateApi
{
     ...
     * @return \Dy05Maviance\S3PApiClient\Model\Bill[]
     */
     ...
     * @throws \Dy05Maviance\S3PApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Dy05Maviance\S3PApiClient\Model\Bill[], HTTP status code, HTTP response headers (array of strings)
     */
    public function billGetWithHttpInfo($xApiVersion, $merchant, $serviceid, $serviceNumber)
    {
        $returnType = '\Dy05Maviance\S3PApiClient\Model\Bill[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Dy05Maviance\S3PApiClient\Model\Bill[]',
     ...
     *
     * @param  string $xApiVersion api version info (required)
     * @param  \Dy05Maviance\S3PApiClient\Model\QuoteRequest $body Quote Request (optional)
     *
     * @throws \Dy05Maviance\S3PApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Dy05Maviance\S3PApiClient\Model\Quote
     */
     ...
     * @throws \Dy05Maviance\S3PApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Dy05Maviance\S3PApiClient\Model\Quote, HTTP status code, HTTP response headers (array of strings)
     */
    public function quotestdPostWithHttpInfo($xApiVersion, $body = null)
    {
        $returnType = '\Dy05Maviance\S3PApiClient\Model\Quote';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Dy05Maviance\S3PApiClient\Model\Quote',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Dy05Maviance\S3PApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Dy05Maviance\S3PApiClient\Model\Subscription[]
     */
     ...
     * @throws \Dy05Maviance\S3PApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Dy05Maviance\S3PApiClient\Model\Subscription[], HTTP status code, HTTP response headers (array of strings)
     */
    public function subscriptionGetWithHttpInfo($xApiVersion, $merchant, $serviceid, $serviceNumber = null, $customerNumber = null)
    {
        $returnType = '\Dy05Maviance\S3PApiClient\Model\Subscription[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Dy05Maviance\S3PApiClient\Model\Subscription[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
