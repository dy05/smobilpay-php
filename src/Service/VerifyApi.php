...
class VerifyApi
{
     ...
     * @return \Dy05Maviance\S3PApiClient\Model\PaymentStatus[]
     */
     ...
     * @throws \Dy05Maviance\S3PApiClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Dy05Maviance\S3PApiClient\Model\PaymentStatus[], HTTP status code, HTTP response headers (array of strings)
     */
    public function historystdGetWithHttpInfo($xApiVersion, $timestampFrom = null, $timestampTo = null)
    {
        $returnType = '\Dy05Maviance\S3PApiClient\Model\PaymentStatus[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Dy05Maviance\S3PApiClient\Model\PaymentStatus[]',
