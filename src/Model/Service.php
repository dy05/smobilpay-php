...
'labelCustomerNumber' => '\Dy05Maviance\S3PApiClient\Model\I18nText[]',
'labelServiceNumber' => '\Dy05Maviance\S3PApiClient\Model\I18nText[]',
'isVerifiable' => 'bool',
'validationMask' => 'string',
'hint' => '\Dy05Maviance\S3PApiClient\Model\I18nText[]',
'denomination' => 'int'    ];
...
self::STATUS_INACTIVE,        ];
     ...
     *
     * @return \Dy05Maviance\S3PApiClient\Model\I18nText[]
     */
     ...
     *
     * @param \Dy05Maviance\S3PApiClient\Model\I18nText[] $labelCustomerNumber Label for customer number in multiple languages (if available) for this service.
     *
     * @return $this
     */
     ...
     *
     * @param \Dy05Maviance\S3PApiClient\Model\I18nText[] $labelServiceNumber Label for service number in multiple languages (if available) for this service.
     *
     * @return $this
     */
     ...
     * Sets hint
     *
     * @param \Dy05Maviance\S3PApiClient\Model\I18nText[] $hint Translation texts for the hint notes to be displayed to the customer for this service.
     *
     * @return $this
     */
